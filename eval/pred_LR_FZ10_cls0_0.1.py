...
Usage:
    ...
    python eval/pred_LR_FZ10_cls0_0.1.py --config configs/021201.yaml --ckpt checkpoints/021201/epoch_27.pth --output eval/pred/wo-anns
...
python eval/pred_LR_FZ10_cls0_0.1.py --config configs/021201-19.yaml --ckpt checkpoints/021201-19/best.pth --output eval/pred/hyperbody

python eval/pred_LR_FZ10_cls0_0.1.py --config configs/021201-19.yaml --ckpt checkpoints/021201-19/epoch_6.pth --output eval/pred/ablation_only_hyper
"""
import argparse
import json
import os
